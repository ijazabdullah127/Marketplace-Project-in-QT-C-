...
static constexpr auto qt_meta_stringdata_ZN8CartPageE = QtMocHelpers::stringData(
    "CartPage",
    "updateCart",
    "",
    "checkout",
...
Q_CONSTINIT static const uint qt_meta_data_ZN8CartPageE[] = {
...
Q_CONSTINIT const QMetaObject CartPage::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN8CartPageE.offsetsAndSizes,
    qt_meta_data_ZN8CartPageE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN8CartPageE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<CartPage, std::true_type>,
        // method 'updateCart'
...
void *CartPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN8CartPageE.stringdata0))
